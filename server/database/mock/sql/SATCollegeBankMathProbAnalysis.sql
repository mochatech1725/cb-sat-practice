...
-- Generated on: 2025-10-21T07:46:24.058Z
-- Total questions: 198
...
INSERT INTO questions (
    ...
    'Medium',
    'Percentages',
    'Problem-Solving and Data Analysis Percentages Difficulty Question ID 9a144a01 ID: 9a144a01 Which of the following is true about the values of  and for ?',
    'C',
...
INSERT INTO questions (
    ...
    'Problem-Solving and Data Analysis Inference from sample statistics and margin of error Difficulty Question ID c178d4da ID: c178d4da ValueData set A frequencyData set B frequency Data set A and data set B each consist of  values. The table shows the frequencies of the values for each data set. Which of the following statements best compares the means of the two data sets?',
    'A',
    '{"A":"The mean of data set A is greater than the mean of data set B.","B":"The mean of data set A is less than the mean of data set B.","C":"The mean of data set A is equal to the mean of data set B.","D":"There is not enough information to compare the means of the data sets."}',
...
INSERT INTO questions (
    ...
    'Medium',
    'One-variable data: Distributions and measures of center and spread',
    'Problem-Solving and Data Analysis One-variable data: Distributions and measures of center and spread Difficulty Question ID d0efc1dd ID: d0efc1dd 15, 14, 18, 17, x The mean and the median of the five numbers above are equal. Which of the following is NOT a possible value of x ?',
    'A',
    '{"A":"6","B":"11","C":"16","D":"21"}',
...
INSERT INTO questions (
    ...
    'Medium',
    'One-variable data: Distributions and measures of center and spread',
    'Problem-Solving and Data Analysis One-variable data: Distributions and measures of center and spread Difficulty Question ID 0301c5dc ID: 0301c5dc The table below shows the number of state parks in a certain state that contain camping facilities and bicycle paths. Has bicycle pathsDoes not have bicycle paths Has camping facilities205 Does not have camping facilities84 If one of these state parks is selected at random, what is the probability that it has camping facilities but does not have bicycle paths? A. B. C. D.',
    'A',
    '{}',
...
INSERT INTO questions (
    ...
    'Easy',
    'Inference from sample statistics and margin of error',
    'Problem-Solving and Data Analysis Inference from sample statistics and margin of error Difficulty Question ID b680e76d ID: b680e76d A survey taken by 1,000 students at a school asked whether they played school sports. The table below summarizes all 1,000 responses from the students surveyed. How many of the males surveyed responded that they do not play a school sport?',
    'B',
...
INSERT INTO questions (
    ...
    'Medium',
    'Percentages',
    'Problem-Solving and Data Analysis Percentages Difficulty Question ID bd90f87e ID: bd90f87e A table of the US minimum wage for 6 different years is shown below. Year US minimum wage (dollars per hour) 19601.00 19701.60 19803.10 19903.80 20005.15 20107.25 What was the percent increase of the minimum wage from 1960 to 1970?',
    'B',
    '{"A":"30%","B":"60%","C":"62.5%","D":"120%"}',
    'Choice B is correct. According to the table, the minimum wage in 1960 was $1.00 per hour, and in 1970 it was $1.60 per hour. The percentage change is therefore . Choice A is incorrect and may result from averaging the two wages before calculating the percentage change. Choice C is incorrect. This is the 1960 wage expressed as a percentage of the 1970 wage, not the percentage change between the two. SAT Math',
    '',
    1
);

-- Question 27: 16cea46c
INSERT INTO questions (
    question_id, assessment, test_type, domain, difficulty,
    skill, question_text, correct_answer,
    answer_choices, explanation, answer_analysis, is_active
...
INSERT INTO questions (
    ...
    'Medium',
    'Probability and conditional probability',
    'Problem-Solving and Data Analysis Probability and conditional probability Difficulty Question ID 46545dd6 ID: 46545dd6 Number of High School Students Who Completed Summer Internships High school Year 20082009201020112012 Foothill8780757670 Valley4454657682 Total131134140152152 The table above shows the number of students from two different high schools who completed summer internships in each of five years. No student attended both schools. Of the students who completed a summer internship in 2010, which of the following represents the fraction of students who were from Valley High School? A. B. C. D.',
    'B',
    '{}',
    'Choice B is correct. According to the table, 140 students from the two high schools completed summer internships in 2010. Of these, 65 were from Valley High School. Therefore, of the students who completed summer internships in 2010, represents the fraction who were from Valley High School. SAT Math',
    '',
    1
);

-- Question 29: ac5b6558
INSERT INTO questions (
    question_id, assessment, test_type, domain, difficulty,
    skill, question_text, correct_answer,
    answer_choices, explanation, answer_analysis, is_active
...
INSERT INTO questions (
    ...
    'Medium',
    'Ratios, rates, proportional relationships, and units',
    'Problem-Solving and Data Analysis Ratios, rates, proportional relationships, and units Difficulty Question ID 52f9a246 ID: 52f9a246 , , , , , , , , Which frequency table correctly represents the data listed? A. NumberFrequency B. NumberFrequency C. NumberFrequency D. NumberFrequency',
    'A',
    '{}',
    'SAT Math',
    '',
...
INSERT INTO questions (
    ...
    'Easy',
    'One-variable data: Distributions and measures of center and spread',
    'Problem-Solving and Data Analysis One-variable data: Distributions and measures of center and spread Difficulty Choice A is correct. A frequency table is a table that lists the data value and shows the number of times the data value occurs. In the data listed, the number  occurs four times, the number  occurs three times, and the number  occurs two times. This corresponds to the table in choice A. Choice B is incorrect. This table has the values for number and frequency reversed. Choice C is incorrect because the frequency values don''t represent the data listed. Choice D is incorrect. This table represents the listed number values as the frequency values. Easy Question ID d89c1513 ID: d89c1513 Customer Purchases at a Gas Station Beverage purchasedBeverage not purchasedTotal Gasoline purchased602585 Gasoline not purchased351550 Total9040135 On Tuesday, a local gas station had 135 customers. The table above summarizes whether or not the customers on Tuesday purchased gasoline, a beverage, both, or neither. Based on the data in the table, what is the probability that a gas station customer selected at random on that day did not purchase gasoline? A. B. C. D.',
    'D',
    '{}',
    'Choice D is correct. The total number of gas station customers on Tuesday was 135. The table shows that the number of customers who did not purchase gasoline was 50. Finding the ratio of the number of customers who did not purchase gasoline to the total number of customers gives the probability that a customer selected at random on that day did not purchase gasoline, which is . Choice A is incorrect and may result from finding the probability that a customer did not purchase a beverage, given that the customer did not purchase gasoline. Choice B is incorrect and may result from finding the probability that a customer did not SAT Math',
    '',
    1
);

-- Question 34: 1353b86e
INSERT INTO questions (
    question_id, assessment, test_type, domain, difficulty,
    skill, question_text, correct_answer,
    answer_choices, explanation, answer_analysis, is_active
    ...
    'Easy',
    'Probability and conditional probability',
    'Problem-Solving and Data Analysis Probability and conditional probability Difficulty purchase gasoline, given that the customer did not purchase a beverage. Choice C is incorrect and may result from finding the probability that a customer did purchase a beverage, given that the customer did not purchase gasoline. Easy Question ID 1353b86e ID: 1353b86e Colors of Marbles in a Bag ColorNumber Red8 Blue10 Green22 Total40 The table shows the number of different colors of marbles in a bag. If a marble is chosen at random from the bag, what is the probability that the marble will be blue? A. B. C. D.',
    'D',
    '{}',
    'Choice D is correct. If a marble is chosen at random from the bag, the probability of choosing a marble of a certain color is the number of marbles of that color divided by the total number of marbles in the bag. Since there are 10 blue marbles in the bag, and there are 40 total marbles in the bag, the probability that the marble chosen will be blue is . Choices A, B, and C are incorrect. These represent the probability that the marble chosen won’t be blue (choice A), will be green (choice B), and won’t be green (choice C). SAT Math',
    '',
    1
);

-- Question 35: 4c774b00
INSERT INTO questions (
    question_id, assessment, test_type, domain, difficulty,
    skill, question_text, correct_answer,
    answer_choices, explanation, answer_analysis, is_active
...
INSERT INTO questions (
    ...
    'Problem-Solving and Data Analysis Evaluating statistical claims: Observational studies and experiments Difficulty Question ID 82aaa0a1 ID: 82aaa0a1 Of the following, which is the best model for the data in the scatterplot? A. B. C. D.',
    'B',
    '{}',
...
INSERT INTO questions (
    ...
    'Easy',
    'One-variable data: Distributions and measures of center and spread',
    'Problem-Solving and Data Analysis One-variable data: Distributions and measures of center and spread Difficulty Question ID f890dc20 ID: f890dc20 What is the median of the seven data values shown?',
    'B',
    '{"A":"2","B":"3","C":"4","D":"9"}',
...
INSERT INTO questions (
    ...
    'Medium',
    'Inference from sample statistics and margin of error',
    'Problem-Solving and Data Analysis Inference from sample statistics and margin of error Difficulty Question ID 8917ce38 ID: 8917ce38 Which of the following speeds is equivalent to 90 kilometers per hour? (1 kilometer = 1,000 meters)',
    'A',
...
INSERT INTO questions (
    ...
    'Easy',
    'Evaluating statistical claims: Observational studies and',
    'Problem-Solving and Data Analysis Evaluating statistical claims: Observational studies and experiments Difficulty Choice A is incorrect. The sample was selected at random from all trivia teams in the tournament, not just from the teams that scored an average of  or more points per round. Choice B is incorrect. If a study uses a sample selected at random from a population, the results of the study can be generalized to the population, not just the sample. Choice C is incorrect. If a study uses a sample selected at random from a population, the results of the study can be generalized to the population, not just a subset of the sample. Hard Question ID 06a152cd ID: 06a152cd To make a bakery’s signature chocolate muffins, a baker needs 2.5 ounces of chocolate for each muffin. How many pounds of chocolate are needed to make 48 signature chocolate muffins? (1 pound = 16 ounces)',
    'A',
...
INSERT INTO questions (
    ...
    'Easy',
    'Two-variable data: Models and scatterplots',
    'Problem-Solving and Data Analysis Two-variable data: Models and scatterplots Difficulty Question ID 708590d7 ID: 708590d7 Which of the following statements correctly compares the means of data set A and data set B?',
    'D',
...
INSERT INTO questions (
    ...
    'Medium',
    'Inference from sample statistics and margin of error',
    'Problem-Solving and Data Analysis Inference from sample statistics and margin of error Difficulty Question ID 3d985614 ID: 3d985614 Each dot in the scatterplot above represents the height x, in feet, in the high jump, and the distance y, in feet, in the long jump, made by each student in a group of twenty students. The graph of which of the following equations is a line that most closely fits the data? A. B. C. D.',
    'C',
    '{}',
...
INSERT INTO questions (
    ...
    'Medium',
    'Ratios, rates, proportional relationships, and units',
    'Problem-Solving and Data Analysis Ratios, rates, proportional relationships, and units Difficulty Question ID 8e2e424e ID: 8e2e424e The number k is 36% greater than 50. If k is the product of 50 and r, what is the value of r ?',
    'C',
...
INSERT INTO questions (
    ...
    'Medium',
    'Ratios, rates, proportional relationships, and units',
    'Problem-Solving and Data Analysis Ratios, rates, proportional relationships, and units Difficulty Question ID 8a714fa1 ID: 8a714fa1 Which of the following represents the result of increasing the quantity x by 9%, where  ? A. B. C. D.',
    'A',
    '{}',
...
INSERT INTO questions (
    ...
    'Hard',
    'Two-variable data: Models and scatterplots',
    'Problem-Solving and Data Analysis Two-variable data: Models and scatterplots Difficulty graph as the value of d at  rather than the value of d at . Choice C is incorrect and may result from misidentifying the y-coordinate of the y-intercept as the smallest value of d on the graph. Hard Question ID 1e8ccffd ID: 1e8ccffd The mean score of 8 players in a basketball game was 14.5 points. If the highest individual score is removed, the mean score of the remaining 7 players becomes 12 points. What was the highest score?',
    'C',
    '{"A":"20","B":"24","C":"32","D":"36"}',
...
INSERT INTO questions (
    ...
    'Medium',
    'One-variable data: Distributions and measures of center and spread',
    'Problem-Solving and Data Analysis One-variable data: Distributions and measures of center and spread Difficulty Question ID 445dd032 ID: 445dd032 Tanya earns $13.50 per hour at her part-time job. When she works z hours, she earns  dollars. Which of the following expressions gives the amount, in dollars, Tanya will earn if she works  hours? A. B. C. D.',
    'A',
    '{}',
...
INSERT INTO questions (
    ...
    'Hard',
    'Ratios, rates, proportional relationships, and units',
    'Problem-Solving and Data Analysis Ratios, rates, proportional relationships, and units Difficulty Question ID 1142af44 ID: 1142af44 ValueFrequency 1a 22a 33a 42a 5a The frequency distribution above summarizes a set of data, where a is a positive integer. How much greater is the mean of the set of data than the median?',
    'A',
    '{"A":"0","B":"1","C":"2","D":"3"}',
...
INSERT INTO questions (
    ...
    'Medium',
    'Ratios, rates, proportional relationships, and units',
    'Problem-Solving and Data Analysis Ratios, rates, proportional relationships, and units Difficulty Question ID ec7b0eb8 ID: ec7b0eb8 Texting behavior Talks on cell phone daily Does not talk on cell phone dailyTotal Light110146256 Medium139164303 Heavy16674240 Total415384799 In a study of cell phone use, 799 randomly selected US teens were asked how often they talked on a cell phone and about their texting behavior. The data are summarized in the table above. If one of the 799 teens surveyed is selected at random, what is the probability that the teen talks on a cell phone daily? A. B. C. D.',
    'B',
    '{}',
    'Choice B is correct. If one of the teens surveyed is selected at random, the probability that the teen talks on a cell phone daily is equal to the quotient of the total number of teens who reported that they talk on a cell phone daily, 415, and the total number of teens surveyed, 799. Therefore, this probability is equal to . SAT Math',
    '',
    1
);

-- Question 83: 2df8f293
INSERT INTO questions (
    question_id, assessment, test_type, domain, difficulty,
    skill, question_text, correct_answer,
    answer_choices, explanation, answer_analysis, is_active
...
INSERT INTO questions (
    ...
    'Medium',
    'Ratios, rates, proportional relationships, and units',
    'Problem-Solving and Data Analysis Ratios, rates, proportional relationships, and units Difficulty Question ID 578e26ae ID: 578e26ae Data set A has  values and is represented by the dot plot shown. Data set B is created by adding  to each of the values in data set A. Which of the following correctly compares the medians and the ranges of data sets A and B? data set A. data set A. data set A. set A.',
    'A',
    '{"A":"The median of data set B is greater than the median of data set A, and the range of data set B is equal to the range of","B":"The median of data set B is greater than the median of data set A, and the range of data set B is greater than the range of","C":"The median of data set B is equal to the median of data set A, and the range of data set B is greater than the range of","D":"The median of data set B is equal to the median of data set A, and the range of data set B is equal to the range of data"}',
...
INSERT INTO questions (
    ...
    'Medium',
    'One-variable data: Distributions and measures of center and spread',
    'Problem-Solving and Data Analysis One-variable data: Distributions and measures of center and spread Difficulty Choice D is incorrect and may result from conceptual or calculation errors. Medium Question ID 181cc4d6 ID: 181cc4d6 Rectangle A has length 15 and width w. Rectangle B has length 20 and the same length-to-width ratio as rectangle A. What is the width of rectangle B in terms of w ? A. B. C. D.',
    'A',
    '{}',
...
INSERT INTO questions (
    ...
    'Easy',
    'Two-variable data: Models and scatterplots',
    'Problem-Solving and Data Analysis Two-variable data: Models and scatterplots Difficulty Question ID e5b5fbdd ID: e5b5fbdd Of the 8 planets in our solar system, 4 are considered rocky. If a student randomly selects 1 of those 8 planets as a topic for a report, what is the probability that the selected planet will be rocky? A. B. C.',
    'C',
    '{"D":"2"}',
...
INSERT INTO questions (
    ...
    'Medium',
    'Two-variable data: Models and scatterplots',
    'Problem-Solving and Data Analysis Two-variable data: Models and scatterplots Difficulty Question ID b4f5a7ca ID: b4f5a7ca A survey was conducted using a sample of history professors selected at random from the California State Universities. The professors surveyed were asked to name the publishers of their current texts. What is the largest population to which the results of the survey can be generalized?',
    'C',
...
INSERT INTO questions (
    ...
    'Hard',
    'Ratios, rates, proportional relationships, and units',
    'Problem-Solving and Data Analysis Ratios, rates, proportional relationships, and units Difficulty Question ID 5dc386fb ID: 5dc386fb The table below shows the distribution of US states according to whether they have a state-level sales tax and a state- level income tax. 2013 State-Level Taxes State sales taxNo state sales tax State income tax394 No state income tax61 To the nearest tenth of a percent, what percent of states with a state-level sales tax do not have a state-level income tax?',
    'C',
...
INSERT INTO questions (
    ...
    'Medium',
    'Probability and conditional probability',
    'Problem-Solving and Data Analysis Probability and conditional probability Difficulty Question ID b6569d0e ID: b6569d0e United States Presidents from 1789 to 2015 AgesNumber 40–442 45–497 50–5413 55–5911 60–647 65–693 The table above gives the number of United States presidents from 1789 to 2015 whose age at the time they first took office is within the interval listed. Of those presidents who were at least 50 years old when they first took office, what fraction were at least 60 years old? A. B. C. D.',
    'B',
    '{}',
    'SAT Math',
    '',
...
INSERT INTO questions (
    ...
    'Hard',
    'Probability and conditional probability',
    'Problem-Solving and Data Analysis Probability and conditional probability Difficulty Choice B is correct. The sample space is restricted to the presidents who were at least 50 years old when they first took office. Therefore, the sum of the values in the final four rows of the table, , is the total number of presidents in the sample space. The number of presidents who were at least 60 years old is the sum of the values in the final two rows of the table: . Thus, the fraction of the 34 presidents who were at least 50 years old when they first took office who were at least 60 years old is . Choice A is incorrect. This is the fraction of all presidents in the table who were at least 60 years old when they first took office. Choice C is incorrect and may result from treating the number of presidents who were between 50 and 59 years old when they first took office, instead of the number of presidents who were at least 50 years old, as the sample space. Choice D is incorrect and may result from a calculation error. Medium Question ID aa43b41f ID: aa43b41f Near the end of a US cable news show, the host invited viewers to respond to a poll on the show’s website that asked, “Do you support the new federal policy discussed during the show?” At the end of the show, the host reported that 28% responded “Yes,” and 70% responded “No.” Which of the following best explains why the results are unlikely to represent the sentiments of the population of the United States?',
    'B',
...
INSERT INTO questions (
    ...
    'Medium',
    'Evaluating statistical claims: Observational studies and',
    'Problem-Solving and Data Analysis Evaluating statistical claims: Observational studies and experiments Difficulty Question ID 4bb25495 ID: 4bb25495 Five Smallest Countries in 2016 Country Land area (square kilometers) Monaco2.0 Nauru21 San Marino61 Tuvalu26 Vatican City0.44 The table above shows the land area, in square kilometers, of the five smallest countries of the world in 2016. Based on the table, what is the mean land area of the 5 smallest countries in 2016, to the nearest square kilometer?',
    'B',
    '{"A":"20","B":"22","C":"61","D":"110"}',
    'Choice B is correct. The mean land area of these 5 countries is equal to the sum of the land areas of these countries, or , divided by the number of countries in the table, 5, or . Combining like terms in the numerator yields , which simplifies to 22.088 square kilometers. This value, when rounded to the nearest square kilometer, is 22. Choice A is incorrect and may result from a calculation error. Choice C is incorrect. This is the greatest land area of the 5 countries in the table. Choice D is incorrect. This is the sum of the land areas of the 5 countries in the table, rounded to the nearest square kilometer. SAT Math',
    '',
    1
);

-- Question 114: dae79de4
INSERT INTO questions (
    question_id, assessment, test_type, domain, difficulty,
    skill, question_text, correct_answer,
    answer_choices, explanation, answer_analysis, is_active
...
INSERT INTO questions (
    ...
    'Easy',
    'Probability and conditional probability',
    'Problem-Solving and Data Analysis Probability and conditional probability Difficulty Question ID 7ed0d098 ID: 7ed0d098 Lani spent 15% of her 8-hour workday in meetings. How many minutes of her workday did she spend in meetings?',
    'D',
...
INSERT INTO questions (
    ...
    'Medium',
    'Ratios, rates, proportional relationships, and units',
    'Problem-Solving and Data Analysis Ratios, rates, proportional relationships, and units Difficulty Question ID 38a9ac45 ID: 38a9ac45 If 1,200 customers register for new accounts at a social media website every day, what fraction of the first 60,000 new accounts are registered in the first 5 days? A. B. C. D.',
    'B',
    '{}',
...
INSERT INTO questions (
    ...
    'Easy',
    'Probability and conditional probability',
    'Problem-Solving and Data Analysis Probability and conditional probability Difficulty Question ID 2a08d878 ID: 2a08d878 There are n nonfiction books and 12 fiction books on a bookshelf. If one of these books is selected at random, what is the probability of selecting a nonfiction book, in terms of n ? A. B. C. D.',
    'B',
    '{}',
...
INSERT INTO questions (
    ...
    'Easy',
    'Percentages',
    'Problem-Solving and Data Analysis Percentages Difficulty Question ID 9296553d ID: 9296553d Which of the following could be an equation for a line of best fit for the data in the scatterplot? A. B. C. D.',
    'A',
    '{}',
...
INSERT INTO questions (
    ...
    'Medium',
    'Two-variable data: Models and scatterplots',
    'Problem-Solving and Data Analysis Two-variable data: Models and scatterplots Difficulty Question ID 9110c120 ID: 9110c120 Which of the following statements about the means and medians of data set A and data set B is true?',
    'A',
...
INSERT INTO questions (
    ...
    'Medium',
    'Evaluating statistical claims: Observational studies and',
    'Problem-Solving and Data Analysis Evaluating statistical claims: Observational studies and experiments Difficulty Question ID 96a45430 ID: 96a45430 A number n is increased 6%. If the result is 318, what is the value of n ?',
    'C',
...
INSERT INTO questions (
    ...
    'Medium',
    'Two-variable data: Models and scatterplots',
    'Problem-Solving and Data Analysis Two-variable data: Models and scatterplots Difficulty Medium Question ID c54b92a2 ID: c54b92a2 A study was conducted on the production rates for a company that produces tractor wheels. The table below shows the number of wheels made during 11 consecutive one-hour production periods. One- hour period Number of wheels made A24 B24 C21 D21 E21 F19 G24 H24 I19 J22 K23 What is the range of the number of wheels made for the 11 one-hour periods?',
    'B',
...
INSERT INTO questions (
    ...
    'Medium',
    'Two-variable data: Models and scatterplots',
    'Problem-Solving and Data Analysis Two-variable data: Models and scatterplots Difficulty Question ID 25fc031a ID: 25fc031a The histograms summarize the distributions of number of units sold, in thousands, for company A and company B. Which statement best compares the standard deviations of number of units sold for these companies? for company B. sold for company B. for company B.',
    'A',
    '{"A":"The standard deviation of number of units sold for company A is less than the standard deviation of number of units sold","B":"The standard deviation of number of units sold for company A is greater than the standard deviation of number of units","C":"The standard deviation of number of units sold for company A is equal to the standard deviation of number of units sold","D":"There is not enough information to compare the standard deviations."}',
    'Choice A is correct. Standard deviation measures the spread of a given data set from its mean. In a data set with a smaller standard deviation, there are more values close to the mean. In a data set with a greater standard deviation, there are more SAT Math',
    '',
    1
);

-- Question 152: d6456c7a
INSERT INTO questions (
    question_id, assessment, test_type, domain, difficulty,
    skill, question_text, correct_answer,
    answer_choices, explanation, answer_analysis, is_active
...
INSERT INTO questions (
    ...
    'Hard',
    'Ratios, rates, proportional relationships, and units',
    'Problem-Solving and Data Analysis Ratios, rates, proportional relationships, and units Difficulty Question ID 9d95e7ad ID: 9d95e7ad The scatterplot above shows the numbers of grams of both total protein and total fat for eight sandwiches on a restaurant menu. The line of best fit for the data is also shown. According to the line of best fit, which of the following is closest to the predicted increase in total fat, in grams, for every increase of 1 gram in total protein?',
    'C',
...
INSERT INTO questions (
    ...
    'Medium',
    'Two-variable data: Models and scatterplots',
    'Problem-Solving and Data Analysis Two-variable data: Models and scatterplots Difficulty Question ID 94237701 ID: 94237701 For a certain computer game, individuals receive an integer score that ranges from 2 through 10. The table below shows the frequency distribution of the scores of the 9 players in group A and the 11 players in group B. Score Score Frequencies Group A Group B 210 310 420 514 632 700 802 911 1002 Total911 The median of the scores for group B is how much greater than the median of the scores for group A?',
    'A',
    '{}',
    'The correct answer is 1. When there are an odd number of values in a data set, the median of the data set is the middle number when the data values are ordered from least to greatest. The scores for group A, ordered from least to greatest, are 2, 3, 4, 4, 5, 6, 6, 6, and 9. The median of the scores for group A is therefore 5. The scores for group B, ordered from least to greatest, are 5, 5, 5, 5, 6, 6, 8, 8, 9, 10, and 10. The median of the scores for group B is therefore 6. The median score for group B is  more than the median score for group A. SAT Math',
    '',
    1
);

-- Question 156: 20b69297
INSERT INTO questions (
    question_id, assessment, test_type, domain, difficulty,
    skill, question_text, correct_answer,
    answer_choices, explanation, answer_analysis, is_active
    ...
    'Hard',
    'One-variable data: Distributions and measures of center and spread',
    'Problem-Solving and Data Analysis One-variable data: Distributions and measures of center and spread Difficulty Hard Question ID 20b69297 ID: 20b69297 Anita created a batch of green paint by mixing 2 ounces of blue paint with 3 ounces of yellow paint. She must mix a second batch using the same ratio of blue and yellow paint as the first batch. If she uses 5 ounces of blue paint for the second batch, how much yellow paint should Anita use?',
    'D',
...
INSERT INTO questions (
    ...
    'Easy',
    'Probability and conditional probability',
    'Problem-Solving and Data Analysis Probability and conditional probability Difficulty Question ID 41b71b4e ID: 41b71b4e What number is 20% greater than 60 ?',
    'B',
...
INSERT INTO questions (
    ...
    'Easy',
    'Two-variable data: Models and scatterplots',
    'Problem-Solving and Data Analysis Two-variable data: Models and scatterplots Difficulty Question ID 808f7d6c ID: 808f7d6c If , which of the following is equivalent to ? A. B. C. D.',
    'A',
    '{}',
...
INSERT INTO questions (
    ...
    'Medium',
    'Ratios, rates, proportional relationships, and units',
    'Problem-Solving and Data Analysis Ratios, rates, proportional relationships, and units Difficulty Question ID 6670e407 ID: 6670e407 Number of High School Students Who Completed Summer Internships High school Year 20082009201020112012 Foothill8780757670 Valley4454657682 Total131134140152152 The table above shows the number of students from two different high schools who completed summer internships in each of five years. No student attended both schools. Which of the following statements are true about the number of students who completed summer internships for the 5 years shown? 1. The mean number from Foothill High School is greater than the mean number from Valley High School. 2. The median number from Foothill High School is greater than the median number from Valley High School.',
    'C',
    '{"A":"I only","B":"II only","C":"I and II","D":"Neither I nor II"}',
    'Choice C is correct. The mean of a data set is found by dividing the sum of the values by the number of values. Therefore, the mean number of students who completed summer internships from Foothill High School is , or 77.6. Similarly, the mean number from Valley High School is SAT Math',
    '',
    1
);

-- Question 169: a3384df0
INSERT INTO questions (
    question_id, assessment, test_type, domain, difficulty,
    skill, question_text, correct_answer,
    answer_choices, explanation, answer_analysis, is_active
    ...
    'Easy',
    'One-variable data: Distributions and measures of center and spread',
    'Problem-Solving and Data Analysis One-variable data: Distributions and measures of center and spread Difficulty , or 64.2. Thus, the mean number from Foothill High School is greater than the mean number from Valley High School. When a data set has an odd number of elements, the median can be found by ordering the values from least to greatest and determining the value in the middle. Since there are fiv   e values in each data set, the third value in each ordered list is the median. Therefore, the median number from Foothill High School is 76 and the median number from Valley High School is 65. Thus, the median number from Foothill High School is greater than the median number from Valley High School. Choices A, B, and D are incorrect and may result from various misconceptions or miscalculations. Easy Question ID a3384df0 ID: a3384df0 Penguin Exhibit Type of penguinMaleFemaleTotal Chinstrap  41  59100 Emperor    8  27  35 Gentoo  49  54103 Macaroni  42  40  82 Total140180320 The number of penguins in a zoo exhibit, sorted by gender and type of penguin, is shown in the table above. Which type of penguin has a female population that is the closest to being  of the total female penguin population in the exhibit?',
    'A',
    '{"A":"Chinstrap","B":"Emperor","C":"Gentoo","D":"Macaroni"}',
    'Choice A is correct. It is given that there are 180 female penguins in the exhibit. Therefore,  of the female penguins is penguins. According to the table, there are 59 female chinstrap penguins, 27 female emperor penguins, 54 female gentoo penguins, and 40 female macaroni penguins. So the female chinstrap penguin population is the closest to 60, or  of the total female population in the exhibit. SAT Math',
    '',
    1
);

-- Question 170: 869a32f1
INSERT INTO questions (
    question_id, assessment, test_type, domain, difficulty,
    skill, question_text, correct_answer,
    answer_choices, explanation, answer_analysis, is_active
...
INSERT INTO questions (
    ...
    'Medium',
    'Percentages',
    'Problem-Solving and Data Analysis Percentages Difficulty Question ID fdfc90e4 ID: fdfc90e4 The scatterplot shows the relationship between two variables,  and . A line of best fit for the data is also shown. At , which of the following is closest to the y-value predicted by the line of best fit? A. B. C. D.',
    'C',
    '{}',
    'Choice C is correct. At , the line of best fit has a y-value between  and . The only choice with a value between  and is choice C. Choice A is incorrect. This is the difference between the y-value predicted by the line of best fit and the actual y-value at rather than the y-value predicted by the line of best fit at . Choice B is incorrect. This is the y-value predicted by the line of best fit at  rather than at . Choice D is incorrect. This is the y-value predicted by the line of best fit at  rather than at . SAT Math',
    '',
    1
);

-- Question 177: 1dcea480
INSERT INTO questions (
    question_id, assessment, test_type, domain, difficulty,
    skill, question_text, correct_answer,
    answer_choices, explanation, answer_analysis, is_active
...
INSERT INTO questions (
    ...
    'Hard',
    'Two-variable data: Models and scatterplots',
    'Problem-Solving and Data Analysis Two-variable data: Models and scatterplots Difficulty passes through the points  and , both of which lie at the bottom of the cluster of points, so it cannot be a line of best fit. Choice D is incorrect and may result from correctly calculating the slope of a line of best fit but incorrectly assuming the y-intercept is at . Hard Question ID 89f20d9e ID: 89f20d9e The table summarizes the distribution of age and assigned group for  participants in a study. – years– years yearsTotal Group A Group B Group C Total One of these participants will be selected at random. What is the probability of selecting a participant from group A, given that the participant is at least 10 years of age? A. B. C. D.',
    'B',
    '{}',
...
INSERT INTO questions (
    ...
    'Easy',
    'Ratios, rates, proportional relationships, and units',
    'Problem-Solving and Data Analysis Ratios, rates, proportional relationships, and units Difficulty Question ID 1c2f50a6 ID: 1c2f50a6 During a sale, the original prices of all the items in a clothing store have been reduced by 20%. What is the sale price of a jacket with an original price of $50 ?',
    'D',
    '{"A":"$12","B":"$30","C":"$36","D":"$40"}',
...
INSERT INTO questions (
    ...
    'Medium',
    'Two-variable data: Models and scatterplots',
    'Problem-Solving and Data Analysis Two-variable data: Models and scatterplots Difficulty Question ID a067c926 ID: a067c926 The bar graph shows the distribution of the number of students from one school who were born in one of four months. 70 60 50 40 30 20 10 0 Number of students July August September October Month How many more students were born in August than were born in July? A. B. C. D.',
    'D',
    '{}',
    'Choice D is correct. It''s given that the bar graph shows the number of students from one school who were born in either July, August, September, or October. The bar representing the number of students born in August has a height of ; therefore, students were born in August. The bar representing the number of students born in July has a height of ; therefore, students were born in July. Thus, there were , or  more students born in August than in July. SAT Math',
    '',
    1
);

-- Question 189: 8c5dbd3e
INSERT INTO questions (
    question_id, assessment, test_type, domain, difficulty,
    skill, question_text, correct_answer,
    answer_choices, explanation, answer_analysis, is_active
...
INSERT INTO questions (
    ...
    'Medium',
    'Percentages',
    'Problem-Solving and Data Analysis Percentages Difficulty Question ID 9d935bd8 ID: 9d935bd8 A survey was given to residents of all 50 states asking if they had earned a bachelor’s degree or higher. The results from 7 of the states are given in the table above. The median percent of residents who earned a bachelor’s degree or higher for all 50 states was 26.95%. What is the difference between the median percent of residents who earned a bachelor’s degree or higher for these 7 states and the median for all 50 states?',
    'B',
    '{"A":"0.05%","B":"0.95%","C":"1.22%","D":"7.45%"}',
    'Choice B is correct. The median of a set of numbers is the middle value of the set values when ordered from least to greatest. If the percents in the table are ordered from least to greatest, the middle value is 27.9%. The difference between 27.9% and 26.95% is 0.95%. Choice A is incorrect and may be the result of calculation errors or not finding the median of the data in the table correctly. Choice C is incorrect and may be the result of finding the mean instead of the median. Choice D is incorrect and may be the result of using the middle value of the unordered list. SAT Math',
    '',
    1
);

-- Question 191: 99550621
INSERT INTO questions (
    question_id, assessment, test_type, domain, difficulty,
    skill, question_text, correct_answer,
    answer_choices, explanation, answer_analysis, is_active
...
INSERT INTO questions (
    ...
    'Medium',
    'Two-variable data: Models and scatterplots',
    'Problem-Solving and Data Analysis Two-variable data: Models and scatterplots Difficulty',
    'A',
    '{}',
    '',
    '',
